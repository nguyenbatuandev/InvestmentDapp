...
namespace InvestDapp.Infrastructure.Migrations
{
    ...
    [Migration("20251005023349_ChangeTradingFeeConfigToDouble")]
    partial class ChangeTradingFeeConfigToDouble
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.ProfitClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ClaimerWallet")
                        .IsRequired()
                        .HasMaxLength(42)
                        .HasColumnType("nvarchar(42)");
                    ...
                    b.HasIndex("ClaimerWallet");

                    b.HasIndex("ProfitId");

                    b.ToTable("ProfitClaims");
                });
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.Staff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.StaffRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.Support.SupportTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AutomationNotes")
                        .HasMaxLength(250)
                    ...
                    b.Property<DateTime?>("LastAgentReplyAt")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("LastCustomerReplyAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.Support.SupportTicketAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SupportTicketAssignments");
                });

            modelBuilder.Entity("InvestDapp.Shared.Models.Support.SupportTicketAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.Support.SupportTicketMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.Trading.TradingAccountLock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UnlockedByAdmin")
                        .HasMaxLength(42)
                        .HasColumnType("nvarchar(42)");
                    ...
                    b.ToTable("TradingAccountLocks");
                });

            modelBuilder.Entity("InvestDapp.Shared.Models.Trading.TradingFeeConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.ProfitClaim", b =>
                {
                    b.HasOne("InvestDapp.Shared.Models.Profit", "Profit")
                        .WithMany()
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.StaffRole", b =>
                {
                    b.HasOne("InvestDapp.Shared.Models.Staff", "Staff")
                        .WithMany("StaffRoles")
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.Support.SupportTicket", b =>
                {
                    b.HasOne("InvestDapp.Shared.Models.User", "AssignedToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.Support.SupportTicketAssignment", b =>
                {
                    b.HasOne("InvestDapp.Shared.Models.User", "AssignedByUser")
                        .WithMany()
                    ...
                    b.HasOne("InvestDapp.Shared.Models.Support.SupportTicket", "Ticket")
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.Support.SupportTicketAttachment", b =>
                {
                    b.HasOne("InvestDapp.Shared.Models.Support.SupportTicketMessage", "Message")
            ...
            modelBuilder.Entity("InvestDapp.Shared.Models.Support.SupportTicketMessage", b =>
                {
                    b.HasOne("InvestDapp.Shared.Models.User", "SenderUser")
                        .WithMany()
